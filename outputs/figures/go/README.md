...
![cnet Hi vs PBS GO:BP](cnet_Hi_vs_PBS_BP.png)
...
![cnet Lo vs PBS GO:BP](cnet_Lo_vs_PBS_BP.png)
...
![cnet Med vs PBS GO:BP](cnet_Med_vs_PBS_BP.png)
...
![dotplot gseGO Hi GO:BP](dotplot_gseGO_Hi_BP.png)
**GO:BP dot plot for Hi** — Each point represents a significantly enriched biological process. The x-axis shows enrichment score, point size corresponds to gene count, and color indicates adjusted p-value.

---
### dotplot gseGO Lo GO:BP

![dotplot gseGO Lo GO:BP](dotplot_gseGO_Lo_BP.png)
...
![dotplot gseGO Med GO:BP](dotplot_gseGO_Med_BP.png)
...
![emap Hi vs PBS GO:BP](emap_Hi_vs_PBS_BP.png)
...
![emap Lo vs PBS GO:BP](emap_Lo_vs_PBS_BP.png)
...
![emap Med vs PBS GO:BP](emap_Med_vs_PBS_BP.png)
